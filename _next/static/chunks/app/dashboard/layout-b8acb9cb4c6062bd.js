(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[954],{1949:(e,r,t)=>{"use strict";t.r(r),t.d(r,{default:()=>p});var a=t(5155),n=t(2115),i=t(6743),o=t(3321),s=t(8500),d=t.n(s);function l(){let e=(0,o.usePathname)(),[r,t]=(0,n.useState)(!1),i=[{name:"Overview",path:"/dashboard/",icon:"\uD83D\uDCCA"},{name:"Upload App",path:"/dashboard/upload/",icon:"\uD83D\uDE80"},{name:"My Apps",path:"/dashboard/apps/",icon:"\uD83D\uDCF1"},{name:"Settings",path:"/dashboard/settings/",icon:"⚙️"}],s=e.endsWith("/")?e:e+"/";return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsxs)("aside",{className:"dash-sidebar",children:[(0,a.jsx)("div",{style:{padding:"0 24px",marginBottom:"32px"},children:(0,a.jsxs)(d(),{href:"/aerostore/",style:{textDecoration:"none",display:"flex",alignItems:"center",gap:"12px"},children:[(0,a.jsx)("div",{style:{width:"32px",height:"32px",background:"linear-gradient(135deg, var(--c1), var(--c2))",borderRadius:"8px"}}),(0,a.jsx)("span",{style:{fontSize:"18px",fontWeight:700,color:"#fff",letterSpacing:"0.5px"},children:"Aero Dev"})]})}),(0,a.jsx)("nav",{style:{display:"flex",flexDirection:"column",gap:"6px",padding:"0 16px",flex:1},children:i.map(e=>{let r=`/aerostore${e.path}`,t=s===r;return(0,a.jsxs)(d(),{href:r,style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px 16px",borderRadius:"10px",textDecoration:"none",color:t?"#fff":"rgba(255,255,255,0.55)",background:t?"var(--surface2)":"transparent",border:t?"1px solid var(--border)":"1px solid transparent",fontWeight:t?600:400,fontSize:"15px",transition:"all 0.2s"},children:[(0,a.jsx)("span",{style:{fontSize:"18px",opacity:t?1:.5},children:e.icon}),e.name]},e.path)})}),(0,a.jsx)("div",{style:{padding:"16px 24px",borderTop:"1px solid var(--border)"},children:(0,a.jsx)(d(),{href:"/aerostore/profile/",style:{fontSize:"14px",color:"rgba(255,255,255,0.4)",textDecoration:"none"},children:"← Back to Profile"})})]}),(0,a.jsxs)("div",{className:"dash-mobile-bar",children:[(0,a.jsx)("button",{onClick:()=>t(!0),style:{background:"none",border:"none",color:"#fff",fontSize:"22px",cursor:"pointer",padding:"4px"},children:"☰"}),(0,a.jsx)("span",{style:{fontSize:"16px",fontWeight:700,letterSpacing:"0.5px"},children:"Aero Dev"}),(0,a.jsx)(d(),{href:"/aerostore/profile/",style:{width:"32px",height:"32px",borderRadius:"50%",background:"linear-gradient(135deg, var(--c1), var(--c2))",display:"flex",alignItems:"center",justifyContent:"center",textDecoration:"none",color:"#fff",fontSize:"14px",fontWeight:700},children:"P"})]}),r&&(0,a.jsx)("div",{className:"dash-mobile-menu",onClick:()=>t(!1),children:(0,a.jsxs)("div",{className:"dash-mobile-menu-inner",onClick:e=>e.stopPropagation(),children:[(0,a.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"32px"},children:[(0,a.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[(0,a.jsx)("div",{style:{width:"32px",height:"32px",background:"linear-gradient(135deg, var(--c1), var(--c2))",borderRadius:"10px"}}),(0,a.jsx)("span",{style:{fontSize:"18px",fontWeight:700,color:"#fff"},children:"Aero Dev"})]}),(0,a.jsx)("button",{onClick:()=>t(!1),style:{background:"rgba(255,255,255,0.08)",border:"none",color:"#fff",fontSize:"18px",cursor:"pointer",width:"36px",height:"36px",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center"},children:"✕"})]}),(0,a.jsx)("nav",{style:{display:"flex",flexDirection:"column",gap:"6px"},children:i.map(e=>{let r=`/aerostore${e.path}`,n=s===r;return(0,a.jsxs)(d(),{href:r,onClick:()=>t(!1),style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px 16px",borderRadius:"12px",textDecoration:"none",color:n?"#fff":"rgba(255,255,255,0.6)",background:n?"linear-gradient(135deg, var(--c1), var(--c2))":"transparent",fontWeight:n?700:500,fontSize:"16px",transition:"all 0.2s",border:n?"none":"1px solid rgba(255,255,255,0.06)"},children:[(0,a.jsx)("span",{style:{fontSize:"20px"},children:e.icon}),e.name]},e.path)})}),(0,a.jsx)("div",{style:{marginTop:"auto",paddingTop:"24px",borderTop:"1px solid rgba(255,255,255,0.06)"},children:(0,a.jsx)(d(),{href:"/aerostore/",onClick:()=>t(!1),style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px 16px",borderRadius:"12px",textDecoration:"none",color:"rgba(255,255,255,0.5)",fontSize:"15px",background:"rgba(255,255,255,0.03)"},children:"\uD83C\uDFE0 Back to Aero Store"})})]})}),(0,a.jsx)("style",{children:`
        /* Desktop sidebar */
        .dash-sidebar {
          width: 260px;
