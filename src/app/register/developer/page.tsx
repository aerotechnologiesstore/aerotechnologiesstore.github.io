...
const THEMES = [
  ...
  { bg:'#000810', bg2:'#001020', surface:'#001428', surface2:'#001a33', c1:'#00A3FF', c2:'#00D4FF', c3:'#7DF9FF', border:'rgba(0,163,255,0.15)', glow:'rgba(0,163,255,0.2)', logo:'/logos/logo-main.png', logoHue: '190deg' },
